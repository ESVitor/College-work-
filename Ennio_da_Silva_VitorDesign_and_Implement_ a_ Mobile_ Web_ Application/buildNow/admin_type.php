    ...
    <body>
       ...
       <div id="div4" >
            ...
            <?php
                ...
                echo '<h3 style="color:red">The user`s account type is updated</h3><br>';    
                }
            ?>
            <br>
            <h3>Edit user's account type</h3>
            
            <form action="#div4" method="post">
            
               User ID:<input type="text" name="text-5" id="text-5"/>
               Account type (customer, staff, delivery, admin):<input type="text" name="text-6" id="text-6"/>
