            ...
            <?php
                ...
                if($_POST){
                    ...
                    try {
                        ...
                        $sql = "UPDATE users SET e_mail = ? WHERE user_id= ?";
                        $sth = $DBH->prepare($sql);
                ...
                echo '<h3 style="color:red">The E-mail address is updated</h3><br>';    
                }
            ?>
            <br>
            <h3>Edit user's E-mail address</h3>
            
            <form action="#div4" method="post">
            
               User ID:<input type="text" name="text-5" id="text-5"/>
               E-mail:<input type="text" name="text-6" id="text-6"/>
