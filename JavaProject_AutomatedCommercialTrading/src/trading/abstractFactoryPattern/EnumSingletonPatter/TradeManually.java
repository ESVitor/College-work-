...
/**
 * Public final class to trade Manually.
 *  
 * @author Ennio
 * @author Thieres
 * @author Fernanda 
 ...
 */
public final class TradeManually {
    ...
    Business companyToTrade = null;
    
    
    // This constructor initialize the array list populating the companies and depots
    public TradeManually() throws CloneNotSupportedException {
    ...
    /**
     * Method to trade manually
     * 
     * @throws java.lang.CloneNotSupportedException gets a exception at the clone process
     * @since version 1.00
     */ 
    public void tradeManually() throws CloneNotSupportedException{       
	...
	int option;
        ...
        do {
            try {
                System.out.println("########################################\n");
                System.out.println("Press [1] to Trade with the company BIGa");
                System.out.println("Press [2] to Trade with the company BIGb");
                System.out.println("Press [3] to Trade with the company BIGc");
        ...
        switch (option) {
            case 1:
		companyToTrade = businessList.get(0);		
		break;
            case 2:
		companyToTrade = businessList.get(1);		
        	break;
            case 3:
		companyToTrade = businessList.get(2);
		break;
        }  
    ...
    public void populateListOfCompany() {
        // Inicial list of companies that will used to populate the Abstract factory.
            ...
            for(int v=0; v<=99; v++){ 
                ...
                for(int i=0; i<=99; i++){                                         
                    ...
                    if(aStockOfB < 3 ||  aStockOfB < 40 && supplierB > 16) {  
                        ...
                        // Check the company that the user whats to trade
                        // Print the values of each trade 
                        if(companyToTrade.equals(businessList.get(0))){
                            int totalCost = order * productBPrice;
                            int totalDelivery = order * deliveryBPrice;
                            int total = totalCost + totalDelivery;
                            System.out.print("Buyer:: DepotA number " + z);
                            System.out.print("|| Seller:: DepotB number " + i);
                            System.out.print("|| Units::" + order);
                            System.out.print("|| Total cost of product::" + totalCost);
                            System.out.print("|| Total cost of delivery::" + totalDelivery);
                            System.out.println("|| Total cost of doing business::" + total);                           
                        }                        
                    }
            ...
            for(int v=0; v<=99; v++){ 
                ...
                for(int i=0; i<=99; i++){ 
                    ...
                    if(bStockOfA < 3 ||  bStockOfA < 40 && supplierA > 16) {
                        ...
                        // Check the company that the user whats to trade
                        // Print the values of each trade 
                        if(companyToTrade.equals(businessList.get(1))){
                            int totalCost = order * productAPrice;
                            int totalDelivery = order * deliveryAPrice;
                            int total = totalCost + totalDelivery;
                            System.out.print("Buyer:: DepotB number " + z);
                            System.out.print("|| Seller:: DepotA number " + i);
                            System.out.print("|| Units::" + order);
                            System.out.print("|| Total cost of product::" + totalCost);
                            System.out.print("|| Total cost of delivery::" + totalDelivery);
                            System.out.println("|| Total cost of doing business::" + total);                           
            ...
            for(int v=0; v<=99; v++){ 
                ...
                for(int i=0; i<=99; i++){ 
                    ...
                    if(aStockOfC < 3 ||  aStockOfC < 40 && supplierC > 16) {
                        ...
                        // Print the values of each trade 
                        if(companyToTrade.equals(businessList.get(0))){
                            int totalCost = order * productCPrice;
                            int totalDelivery = order * deliveryCPrice;
                            int total = totalCost + totalDelivery;
                            System.out.print("Buyer:: DepotA number " + z);
                            System.out.print("|| Seller:: DepotC number " + i);
                            System.out.print("|| Units::" + order);
                            System.out.print("|| Total cost of product::" + totalCost);
                            System.out.print("|| Total cost of delivery::" + totalDelivery);
                            System.out.println("|| Total cost of doing business::" + total);                           
            ...
            for(int v=0; v<=99; v++){ 
                ...
                for(int i=0; i<=99; i++){ 
                    ...
                    if(cStockOfA < 3 ||  cStockOfA < 40 && supplierA > 16) {
                        ...
                        // Check the company that the user whats to trade
                        // Print the values of each trade 
                        if(companyToTrade.equals(businessList.get(2))){
                            int totalCost = order * productAPrice;
                            int totalDelivery = order * deliveryAPrice;
                            int total = totalCost + totalDelivery;
                            System.out.print("Buyer:: DepotC number " + z);
                            System.out.print("|| Seller:: DepotA number " + i);
                            System.out.print("|| Units::" + order);
                            System.out.print("|| Total cost of product::" + totalCost);
                            System.out.print("|| Total cost of delivery::" + totalDelivery);
